...
const ScheduleCard = ({ time, title, description, speaker, location }: ScheduleCardProps) => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Three days of innovation, learning, and coding. Plan your QUBITX-GLBM experience with our detailed schedule.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Tabs defaultValue="day1" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-8 bg-cyber-darker">
              <TabsTrigger value="day1" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-neon-blue/20 data-[state=active]:to-neon-purple/20 data-[state=active]:text-white">
              ...
              <TabsTrigger value="day2" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-neon-blue/20 data-[state=active]:to-neon-purple/20 data-[state=active]:text-white">
                <div className="flex flex-col items-center">
                  <Calendar size={18} className="mb-1" />
                  <span>Day 2</span>
              ...
              <TabsTrigger value="day3" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-neon-blue/20 data-[state=active]:to-neon-purple/20 data-[state=active]:text-white">
                <div className="flex flex-col items-center">
                  <Calendar size={18} className="mb-1" />
                  <span>Day 3</span>
